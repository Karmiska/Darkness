...
UiHandler::UiHandler(QQmlApplicationEngine* engine, QWidget* parent)
    : m_engine{ engine }
    , m_parent{ parent }
    , m_projectName{ "" }
    , m_projectLocation{ "" }
...
void UiHandler::openProject(QString name, QString location)
{
    emit openProject(location);
}

void UiHandler::createProject()
{
    QObject* rootObject = m_engine->rootObjects().first();
    QObject* createProjectSlide = rootObject->findChild<QObject*>("createProjectMainIdName");
    m_createProjectForm = rootObject->findChild<QObject*>("createProjectForm");
...
void UiHandler::nameChanged(QString name)
{
    m_projectName = name;
    QObject* form = m_createProjectForm->findChild<QObject*>("projectNameInput");
...
void UiHandler::locationChanged(QString location)
{
